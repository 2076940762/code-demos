...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<div class="col-md-2">
			<a href="http://localhost:8080/06-cookie-session/history?id=1"> <img
				src="products/1/cs10001.jpg" width="170" height="170"
				style="display: inline-block;">
			</a>
			<p>
				<a href="http://localhost:8080/06-cookie-session/history?id=1"
					style='color: green'>冬瓜</a>
			</p>
			<p>
		...
		<div class="col-md-2">
			<a href="http://localhost:8080/06-cookie-session/history?id=2"> <img
				src="products/1/cs10002.jpg" width="170" height="170"
				style="display: inline-block;">
			</a>
			<p>
				<a href="http://localhost:8080/06-cookie-session/history?id=2"
					style='color: green'>圆白菜</a>
			</p>
			<p>
				<font color="#FF0000">商城价：&yen;299.00</font>
			</p>
		...
		<div class="col-md-2">
			<a href="http://localhost:8080/06-cookie-session/history?id=3"> <img
				src="products/1/cs10003.jpg" width="170" height="170"
				style="display: inline-block;">
			</a>
			<p>
				<a href="http://localhost:8080/06-cookie-session/history?id=3"
					style='color: green'>甜玉米</a>
			</p>
			<p>
				<font color="#FF0000">商城价：&yen;299.00</font>
			</p>
		...
		<div class="col-md-2">
			<a href="http://localhost:8080/06-cookie-session/history?id=4"> <img
				src="products/1/cs10004.jpg" width="170" height="170"
				style="display: inline-block;">
			</a>
			<p>
				<a href="http://localhost:8080/06-cookie-session/history?id=4"
					style='color: green'>胡萝卜</a>
			</p>
			<p>
				<font color="#FF0000">商城价：&yen;299.00</font>
			</p>
	...
	<div
 	...
 	for (String id : arr) {
 %> <a href="http://localhost:8080/06-cookie-session/clearHistory">清空历史记录</a>
				<li
					style="width: 150px; height: 216; float: left; margin: 0 8px 0 0; padding: 0 18px 15px; text-align: center;">
					<img src="products/1/cs1000<%=id%>.jpg" width="130px"
					height="130px" />
				</li>
				<%
					}
