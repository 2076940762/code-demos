...
<html>
    ...
    <BODY>
        ...
        <FORM id=form1 name=form1 action="${pageContext.request.contextPath }/customerServlet?method=add" method="post">
                        ...
                        <TD vAlign=top width="100%" bgColor=#ffffff>
                            ...
                            <TABLE cellSpacing=0 cellPadding=5 border=0>
                                ...
                                <TR>
                                    ...
                                    <td>客户网址 ：</td>
                                    <td>
                                        <INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="cust_website">
                                    </td>
                                </TR>
                                <tr>
                                    <td rowspan=2>
